    ...
    for filename, fulldata in data_list:
        ...
        for test_id, data in tqdm(enumerate(fulldata), total=len(fulldata)):
            ...
            if args.inference_method == "icl":
                ...
                inject_hydra_lora_force_cuda0(model, trained_data_adapters_dir=trained_adapter_dir, alpha=32, target_modules=["gate_proj", "up_proj", "down_proj"])
...
if __name__ == "__main__":
    ...
    parser.add_argument("--sample", type=int, default=50) # -1 means all
